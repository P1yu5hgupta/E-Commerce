...
<div class="sgnup-page">
        <div class="form">
<form action="signp.php" name="myForm" method="post">
    <strong><center><h2><font color="#CCCC00">SIGNUP</font></h2></center></strong>
    <input type="text" name="name" placeholder="Name">
<input type="text" name="mail" placeholder="E-Mail">
<input type="password" name="pass" placeholder="Password">
<input type="password" name="cpass" placeholder="Confirm Password">
<input type="text" name="add" placeholder="Address">
<b><font size="4" color="#FFFFFF" face="Georgia">Gender:&nbsp;&nbsp;</font></b>
...
<b>
    ...
    <button type="submit" onclick="return formvalidate()">SignUp</button>
    <a href="login.php"><font color="#FFFF00">Back to Login</font></a>
</form>    
</div>
    </div>
