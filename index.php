...
<div class="home" style="background-image: url(images/back.jpg)">
    <div class="content">
        <div class="home_slider_title">A new Online Shop experience.</div>
        <div class="home_slider_subtitle">Subtitle.</div>
        <div class="button button_light home_button"><a href="categories.php?cat='All Products...'">Shop Now</a></div>
    </div>
</div>
	<!-- Ads -->
			...
			<div class="avds_small">
				...
				<div class="avds_small_inner">
					...
					<div class="avds_small_content">
						...
						<div class="avds_link"><a href="categories.php?cat='All Products...'">See More</a></div>
					</div>
				</div>
			</div>
			<div class="avds_large">
				...
				<div class="avds_large_container">
					<div class="avds_large_content">
						...
						<div class="avds_text">About.</div>
						<div class="avds_link avds_link_large"><a href="categories.php?cat='All Products...'">See More</a></div>
					</div>
				</div>
			</div>
		</div>
	...
	<!-- Products -->
					...
					<div class="product_grid">
                        ...
                        ?>
                        <div class="product">
							<div class="product_image"><img src="<?php echo $row['c_image'] ?>" alt="" height="200px"></div>
							<div class="product_content">
								<div class="product_title"><a href="categories.php?cat='<?php echo $row['c_name']?>'"><?php echo $row['c_name']?></a></div>
				...
				<div class="col">
					<div class="avds_xl_container clearfix">
						...
						<div class="avds_xl_content">
							...
							<div class="avds_text">Details.</div>
